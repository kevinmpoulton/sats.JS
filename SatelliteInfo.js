let satellite_data = [
    ...
    'frequencies' : 
        {
            'CW' : {'description' : 'CW Beacon', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.660},
            'Telemetry' : {'description' : 'Digital Telemetry', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.640},
    ...
    'frequencies' : 
        {
            ...
            'Telemetry' : {'description' : 'Digital Telemetry', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.705},
    ...
    'frequencies' : 
        {
            ...
            'Telemetry' : {'description' : 'Digital Telemetry', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.770},
    ...
    'frequencies' : 
        {
            ...
            'Telemetry' : {'description' : 'Digital Telemetry', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.835},
            'Linear' : {'description': 'Linear Inverting', 'type' : 'linear_inverting', 'frequency_mid_up': 435.220, 'frequency_mid_down': 145.870, 'bandwidth' : 0.02}
        }
    },
    ...
    'frequencies' : 
        {
            ...
            'Telemetry' : {'description' : 'Digital Telemetry', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.890},
            'Linear' : {'description': 'Linear Inverting', 'type' : 'linear_inverting', 'frequency_mid_up': 435.280, 'frequency_mid_down': 145.925, 'bandwidth' : 0.02}
        }
    },
    ...
    'frequencies' : 
        {
            ...
            'Telemetry' : {'description' : 'Digital Telemetry', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.955},
    ...
    'frequencies' : 
        {
            'CW' : {'description' : 'Mode U/V (B) TLM Beacon', 'type': 'beacon', 'direction':'down', 'frequency_mid': 145.9775},
    ...
    'frequencies' : 
        {
            'Beacon' : {'description': 'CW Beacon', 'type' : 'beacon', 'direction' : 'down', 'frequency_mid': 145.825},
    ...
    'frequencies' : 
        {
            'Beacon' : {'description': 'Beacon', 'type' : 'beacon', 'direction' : 'down', 'frequency_mid': 145.910},
            'Linear' : {'description': 'Linear Inverting', 'type' : 'linear_inverting', 'frequency_mid_up': 435.280, 'frequency_mid_down': 145.925, 'bandwidth' : 0.02},
        }
    }
